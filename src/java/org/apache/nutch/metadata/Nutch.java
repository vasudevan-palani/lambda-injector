...
public interface Nutch {
  ...
  public static final String WRITABLE_GENERATE_TIME_KEY = new String(
      GENERATE_TIME_KEY);

  public static final String PROTO_STATUS_KEY = "_pst_";

  public static final String WRITABLE_PROTO_STATUS_KEY = new String(
      PROTO_STATUS_KEY);
  ...
  public static final String CACHING_FORBIDDEN_KEY_UTF8 = new String(
  ...
  public static final String WRITABLE_REPR_URL_KEY = new String(REPR_URL_KEY);

  public static final String ALL_BATCH_ID_STR = "-all";

  public static final String ALL_CRAWL_ID = new String(ALL_BATCH_ID_STR);
